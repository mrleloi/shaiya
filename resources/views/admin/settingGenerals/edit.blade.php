        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.setting-generals.update", [$settingGeneral->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url_fanpage') ? 'is-invalid' : '' }}" type="text" name="url_fanpage" id="url_fanpage" value="{{ old('url_fanpage', $settingGeneral->url_fanpage) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url_group') ? 'is-invalid' : '' }}" type="text" name="url_group" id="url_group" value="{{ old('url_group', $settingGeneral->url_group) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('meta_keyword') ? 'is-invalid' : '' }}" name="meta_keyword" id="meta_keyword">{{ old('meta_keyword', $settingGeneral->meta_keyword) }}</textarea>
