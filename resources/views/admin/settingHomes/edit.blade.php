        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.setting-homes.update", [$settingHome->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('num_news_display') ? 'is-invalid' : '' }}" type="number" name="num_news_display" id="num_news_display" value="{{ old('num_news_display', $settingHome->num_news_display) }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('num_events_display') ? 'is-invalid' : '' }}" type="number" name="num_events_display" id="num_events_display" value="{{ old('num_events_display', $settingHome->num_events_display) }}" step="1" required>
