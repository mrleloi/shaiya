...
@section('content')
    <aside id="right" class="mainside">
        <div class="page">
            ...
            <center>
                <div class="title" style="padding-bottom: 20px;padding-top: 25px;">
            ...
            <div class="page-body border_box self_clear">
                ...
                @if (!$listType1->isEmpty())
                    ...
                    @if ($listType1->hasPages())
                        <div class="news_pagi border_box self_clear">
                            <div class="news_pagi-left">
                                {{ $listType1->appends(array_merge(request()->query(), ['type' => 1]))->links() }}
                            </div>
                        </div>
                    @endif
            ...
            <div class="content_header border_box">
                <span class="latest_news vertical_center"> TOP LEVEL</span>
            </div>
            <div class="page-body border_box self_clear">
                ...
                @if (!$listType2->isEmpty())
                    ...
                    @if ($listType2->hasPages())
                        <div class="news_pagi border_box self_clear">
                            <div class="news_pagi-left">
                                {{ $listType2->appends(array_merge(request()->query(), ['type' => 2]))->links() }}
                            </div>
                        </div>
                    @endif
